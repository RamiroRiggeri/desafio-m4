...
function addWorkCard(params = {}) {
  ...
  templateEl.content.querySelector(".portfolio-card-link").textContent =
    params.url;
...
function getContentfulData() {
  return fetch(
    "https://cdn.contentful.com/spaces/kpsb0kn6pxr1/environments/master/entries?access_token=o51OBKlPrC9UNzjUw413uMzUzQWo6TFyCMVz9tZEiN4&content_type=work"
  )
    .then((res) => res.json())
    .then((data) => {
